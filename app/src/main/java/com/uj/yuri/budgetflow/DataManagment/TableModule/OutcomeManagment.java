...
import com.uj.yuri.budgetflow.DataManagment.GatewayTemplate.OutcomeGatewayTemplate;
...
public class OutcomeManagment {
    ...
    private OutcomeGatewayTemplate outcomeGateway ;

    public OutcomeManagment(Context ctx) {
        this.outcomeGateway = new OutcomeGatewayTemplate(ctx);
    }

    public OutcomeGatewayTemplate getOutcomeGateway() {
