...
import static com.uj.yuri.budgetflow.DataManagment.ObjectsDO.Entries.SQL_CREATE_ENTRIES_Categories;
import static com.uj.yuri.budgetflow.DataManagment.ObjectsDO.Entries.SQL_CREATE_ENTRIES_Hist_Saldo;
import static com.uj.yuri.budgetflow.DataManagment.ObjectsDO.Entries.SQL_CREATE_ENTRIES_Incomes;
import static com.uj.yuri.budgetflow.DataManagment.ObjectsDO.Entries.SQL_CREATE_ENTRIES_Outcomes;
...
public class GatewayTemplate extends SQLiteOpenHelper {

    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "BudgetFlow.db";
    protected  SQLiteDatabase dba;

    public GatewayTemplate(Context context) {
