...
public class EditIncomes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Edit Incomes");
        ...
        if (extras != null)
        {
            ...
            if (!out.equals("")) {
                //Outcomes
                ele = gatewayLogicDB.findIncome(out);
                ...
                date_placeTo1.setText(ele.getEndTime());
                    ...
                    amount.setText(format.format(ele.getAmount().amount().doubleValue()));
    ...
    private void submitForm() {
        ...
        if( radio_btn1.isChecked()){
            gatewayLogicDB.DailySetUp(date_split, dd, past, today, infinity, createPreparedOneNotInf(), createPreparedOneInf());
        } else if (radio_btn2.isChecked()) {
            gatewayLogicDB.MontlySetUp(date_split, dd, past, today, infinity, createPreparedOneNotInf(), createPreparedOneInf());
        } else {
            gatewayLogicDB.update(new Income(ele.getId(), note.getText().toString(), amount.getText().toString(), date_place1.getText().toString(), date_placeTo1.getText().toString(), true, getFreq() + "", "", 2));
        }
